...
class Configuration:
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument(
            "--egoexo_root", help="EgoExo data root", default="../data/egoexo"
        )
        ...
        parser.add_argument(
            "--hidden_dim", default=64, help="Set to =0 to disable", type=int
        )
        ...
        parser.add_argument(
            "--s0_lr", help="Initial learning rate", default=1e-5, type=float
        )
        ...
        parser.add_argument(
            "--s1_lr", help="Initial learning rate", default=1e-5, type=float
        )
        ...
        parser.add_argument(
            "--s2_lr", help="Initial learning rate", default=1e-5, type=float
        )
